...
const CellComponent = ({ cell, gameStage, turnStage, playerColor, addFigure, availableCells, chooseFigure, moveFigure }) => {
    let color;
    ...
    return (
        <div
            className={['cell', color, available, figureClass, focus].join(" ")}
